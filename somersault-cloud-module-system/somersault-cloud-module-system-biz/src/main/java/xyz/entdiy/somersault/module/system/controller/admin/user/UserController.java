package xyz.entdiy.somersault.module.system.controller.admin.user;
...
public class UserController {
    ...
    public void importTemplate(HttpServletResponse response) throws IOException {
        ...
        List<UserImportExcelVO> list = Arrays.asList(
                UserImportExcelVO.builder().username("test1").deptId(1L).email("test1@mail-mock.com").mobile("")
                        .nickname("姓名1").status(CommonStatusEnum.ENABLE.getStatus()).sex(SexEnum.MALE.getSex()).build(),
                UserImportExcelVO.builder().username("test2").deptId(2L).email("test2@mail-mock.com").mobile("")
                        .nickname("姓名2").status(CommonStatusEnum.DISABLE.getStatus()).sex(SexEnum.FEMALE.getSex()).build()
        );
