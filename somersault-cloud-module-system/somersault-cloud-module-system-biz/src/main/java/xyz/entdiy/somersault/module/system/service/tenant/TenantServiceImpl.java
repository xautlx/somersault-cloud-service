...
import xyz.entdiy.somersault.framework.tenant.core.util.TenantUtils;
import xyz.entdiy.somersault.module.system.controller.admin.permission.vo.role.RoleCreateReqVO;
...
import xyz.entdiy.somersault.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 biz.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
