package xyz.entdiy.somersault.module.system.controller.admin.auth;
...
import xyz.entdiy.somersault.framework.security.config.SecurityProperties;
...
import static xyz.entdiy.somersault.framework.security.core.util.SecurityFrameworkUtils.obtainAuthorization;
    ...
    public CommonResult<AuthPermissionInfoRespVO> getPermissionInfo() {
        ...
        for (RoleDO roleDO : roles) {
            if (RoleCodeEnum.isSuperAdmin(roleDO.getCode())) {
                //详见前端 hasPermi.ts 文件中 all_permission 定义值保持一致
                respVO.setPermissions(SetUtils.asSet("*:*:*"));
                break;
            }
        }
