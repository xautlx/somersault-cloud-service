package xyz.entdiy.somersault.module.system.controller.admin.ip;

import cn.hutool.core.lang.Assert;
import xyz.entdiy.somersault.framework.common.pojo.CommonResult;
import xyz.entdiy.somersault.framework.ip.core.Area;
import xyz.entdiy.somersault.framework.ip.core.utils.AreaUtils;
import xyz.entdiy.somersault.framework.ip.core.utils.IPUtils;
...
import xyz.entdiy.somersault.module.system.convert.ip.AreaConvert;
...
public class AreaController {
    ...
    //是不是叫 getAreaListByIds 更合适。 因为不一定是子节点。 用于前端树选择获取缓存数据。 见 <el-tree-select :cache-data="areaCache">
