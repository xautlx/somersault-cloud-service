...
import xyz.entdiy.somersault.module.system.dal.mysql.permission.MenuMapper;
import xyz.entdiy.somersault.module.system.enums.permission.MenuTypeEnum;
...
import static xyz.entdiy.somersault.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("测试").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setStatus(CommonStatusEnum.DISABLE.getStatus())));
        // 测试 name 不匹配
        menuMapper.insert(cloneIgnoreId(menuDO, o -> o.setName("试")));
        // 准备参数
        MenuListReqVO reqVO = new MenuListReqVO().setName("测").setStatus(CommonStatusEnum.ENABLE.getStatus());
