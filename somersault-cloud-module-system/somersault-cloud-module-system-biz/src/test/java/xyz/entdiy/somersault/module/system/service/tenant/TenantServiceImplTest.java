package xyz.entdiy.somersault.module.system.service.tenant;
...
import xyz.entdiy.somersault.framework.tenant.config.TenantProperties;
...
import xyz.entdiy.somersault.module.system.controller.admin.tenant.vo.tenant.TenantExportReqVO;
import xyz.entdiy.somersault.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
...
import xyz.entdiy.somersault.module.system.dal.mysql.tenant.TenantMapper;
import xyz.entdiy.somersault.module.system.enums.permission.RoleCodeEnum;
import xyz.entdiy.somersault.module.system.enums.permission.RoleTypeEnum;
import xyz.entdiy.somersault.module.system.service.permission.MenuService;
import xyz.entdiy.somersault.module.system.service.permission.PermissionService;
import xyz.entdiy.somersault.module.system.service.permission.RoleService;
import xyz.entdiy.somersault.module.system.service.tenant.handler.TenantInfoHandler;
import xyz.entdiy.somersault.module.system.service.tenant.handler.TenantMenuHandler;
...
import static xyz.entdiy.somersault.framework.common.util.collection.SetUtils.asSet;
...
import static xyz.entdiy.somersault.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
import static xyz.entdiy.somersault.module.system.enums.ErrorCodeConstants.*;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            assertEquals("ceshi", user.getUsername());
            assertEquals("yuanma", user.getPassword());
            assertEquals("测试", user.getNickname());
        ...
        TenantCreateReqVO reqVO = randomPojo(TenantCreateReqVO.class, o -> {
            ...
            o.setDomain("https://www.test.com");
            o.setUsername("ceshi");
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("测试"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("测试");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
