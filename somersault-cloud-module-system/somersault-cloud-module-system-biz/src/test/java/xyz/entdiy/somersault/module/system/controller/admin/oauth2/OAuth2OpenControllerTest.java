...
import xyz.entdiy.somersault.module.system.enums.oauth2.OAuth2GrantTypeEnum;
import xyz.entdiy.somersault.module.system.service.oauth2.OAuth2ApproveService;
import xyz.entdiy.somersault.module.system.service.oauth2.OAuth2ClientService;
import xyz.entdiy.somersault.module.system.service.oauth2.OAuth2GrantService;
...
import static xyz.entdiy.somersault.framework.test.core.util.RandomUtils.randomString;
...
public class OAuth2OpenControllerTest extends BaseMockitoUnitTest {
    ...
    public void testApproveOrDeny_ApproveNo() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.test.com#error=access_denied&error_description=User%20denied%20access&state=test", result.getData());
    }
    ...
    public void testApproveOrDeny_autoApproveWithToken() {
        ...
        assertThat(result.getData(), anyOf( // 29 和 30 都有一定概率，主要是时间计算
                is("https://www.test.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=29&scope=read"),
                is("https://www.test.com#access_token=test_access_token&token_type=bearer&state=test&expires_in=30&scope=read")
        ));
    }
    ...
    public void testApproveOrDeny_approveWithCode() {
        ...
        // 断言
        assertEquals(0, result.getCode());
        assertEquals("https://www.test.com?code=test_code&state=test", result.getData());
    }
