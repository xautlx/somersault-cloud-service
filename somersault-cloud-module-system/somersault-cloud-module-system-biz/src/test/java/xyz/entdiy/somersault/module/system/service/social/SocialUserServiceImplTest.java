...
import xyz.entdiy.somersault.module.system.dal.mysql.social.SocialUserBindMapper;
import xyz.entdiy.somersault.module.system.dal.mysql.social.SocialUserMapper;
...
import static xyz.entdiy.somersault.module.system.enums.ErrorCodeConstants.SOCIAL_USER_AUTH_FAILURE;
import static xyz.entdiy.somersault.module.system.enums.ErrorCodeConstants.SOCIAL_USER_NOT_FOUND;
...
public class SocialUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetAuthorizeUrl() {
        try (MockedStatic<AuthStateUtils> authStateUtilsMock = mockStatic(AuthStateUtils.class)) {
            ...
            when(authRequest.authorize(eq("aoteman"))).thenReturn("https://www.test.com?redirect_uri=yyy");

            // 调用
            String url = socialUserService.getAuthorizeUrl(type, redirectUri);
            // 断言
            assertEquals("https://www.test.com?redirect_uri=sss", url);
        }
    }
