package xyz.entdiy.somersault.module.system.service.dict;
...
import xyz.entdiy.somersault.framework.common.util.collection.ArrayUtils;
import xyz.entdiy.somersault.framework.test.core.ut.BaseDbUnitTest;
import xyz.entdiy.somersault.module.system.controller.admin.dict.vo.data.DictDataCreateReqVO;
import xyz.entdiy.somersault.module.system.controller.admin.dict.vo.data.DictDataExportReqVO;
import xyz.entdiy.somersault.module.system.controller.admin.dict.vo.data.DictDataPageReqVO;
import xyz.entdiy.somersault.module.system.controller.admin.dict.vo.data.DictDataUpdateReqVO;
...
import xyz.entdiy.somersault.module.system.dal.mysql.dict.DictDataMapper;
...
public class DictDataServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetDictDataList() {
        // mock 数据
        DictDataDO dictDataDO01 = randomDictDataDO().setDictType("ceshi").setSort(2);
        dictDataMapper.insert(dictDataDO01);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("ceshi").setSort(1);
    ...
    public void testGetDictDataPage() {
        ...
        // 测试 label 不匹配
        dictDataMapper.insert(cloneIgnoreId(dbDictData, o -> o.setLabel("试")));
        // 测试 dictType 不匹配
        dictDataMapper.insert(cloneIgnoreId(dbDictData, o -> o.setDictType("shi")));
        // 测试 status 不匹配
    ...
    public void testCountByDictType() {
        // mock 数据
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("ceshi")));
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("tudou")));
        dictDataMapper.insert(randomDictDataDO(o -> o.setDictType("ceshi")));
        // 准备参数
        String dictType = "ceshi";
    ...
    public void testGetDictData_dictType() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("ceshi").setValue("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("ceshi").setValue("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "ceshi";
        String value = "1";
    ...
    public void testParseDictData() {
        // mock 数据
        DictDataDO dictDataDO = randomDictDataDO().setDictType("ceshi").setLabel("1");
        dictDataMapper.insert(dictDataDO);
        DictDataDO dictDataDO02 = randomDictDataDO().setDictType("ceshi").setLabel("2");
        dictDataMapper.insert(dictDataDO02);
        // 准备参数
        String dictType = "ceshi";
        String label = "1";
