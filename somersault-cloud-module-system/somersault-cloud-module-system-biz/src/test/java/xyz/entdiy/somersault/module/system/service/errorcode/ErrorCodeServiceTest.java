package xyz.entdiy.somersault.module.system.service.errorcode;
...
import xyz.entdiy.somersault.module.system.controller.admin.errorcode.vo.ErrorCodeExportReqVO;
import xyz.entdiy.somersault.module.system.controller.admin.errorcode.vo.ErrorCodePageReqVO;
...
import xyz.entdiy.somersault.module.system.dal.mysql.errorcode.ErrorCodeMapper;
import xyz.entdiy.somersault.module.system.enums.errorcode.ErrorCodeTypeEnum;
...
import static xyz.entdiy.somersault.module.system.enums.ErrorCodeConstants.ERROR_CODE_DUPLICATE;
import static xyz.entdiy.somersault.module.system.enums.ErrorCodeConstants.ERROR_CODE_NOT_EXISTS;
...
public class ErrorCodeServiceTest extends BaseDbUnitTest {
    ...
    private ErrorCodeDO initGetErrorCodePage() {
        ...
        // 测试 message 不匹配
        errorCodeMapper.insert(cloneIgnoreId(dbErrorCode, o -> o.setMessage("shi")));
        // 测试 createTime 不匹配
    ...
    public void testGetErrorCodeList() {
        ...
        ErrorCodeDO errorCodeDO01 = randomErrorCodeDO(
                o -> o.setApplicationName("ceshi_server").setUpdateTime(buildTime(2022, 1, 10)));
        errorCodeMapper.insert(errorCodeDO01);
        ErrorCodeDO errorCodeDO02 = randomErrorCodeDO(
                o -> o.setApplicationName("ceshi_server").setUpdateTime(buildTime(2022, 1, 12)));
        errorCodeMapper.insert(errorCodeDO02);
        // mock 方法
        String applicationName = "ceshi_server";
