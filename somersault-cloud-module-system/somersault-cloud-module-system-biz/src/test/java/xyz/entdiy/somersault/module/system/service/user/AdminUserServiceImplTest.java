package xyz.entdiy.somersault.module.system.service.user;
...
import xyz.entdiy.somersault.module.system.dal.mysql.dept.UserPostMapper;
import xyz.entdiy.somersault.module.system.dal.mysql.user.AdminUserMapper;
import xyz.entdiy.somersault.module.system.enums.common.SexEnum;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("ceshiyuanma");
        ...
        assertEquals("ceshiyuanma", user.getPassword());
    ...
    public void testGetUserListByNickname() {
        // mock 数据
        AdminUserDO user = randomAdminUserDO(o -> o.setNickname("测试"));
        userMapper.insert(user);
        // 测试 nickname 不匹配
