...
import xyz.entdiy.somersault.module.infra.enums.codegen.CodegenColumnHtmlTypeEnum;
import xyz.entdiy.somersault.module.infra.enums.codegen.CodegenColumnListConditionEnum;
import xyz.entdiy.somersault.module.infra.enums.codegen.CodegenTemplateTypeEnum;
...
public class CodegenBuilder {
    ...
    /**
     * {@link xyz.entdiy.somersault.framework.mybatis.core.dataobject.BaseDO} 的字段
     */
    ...
    private void processColumnExample(CodegenColumnDO column) {
        ...
        if (StrUtil.endWithIgnoreCase(column.getColumnName(), "url")) {
            column.setExample("https://www.test.com");
            return;
        }
        // reason
