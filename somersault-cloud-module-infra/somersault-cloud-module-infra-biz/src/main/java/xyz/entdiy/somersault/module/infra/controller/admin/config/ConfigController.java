package xyz.entdiy.somersault.module.infra.controller.admin.config;
...
import xyz.entdiy.somersault.module.infra.controller.admin.config.vo.*;
...
import xyz.entdiy.somersault.module.infra.enums.ErrorCodeConstants;
import xyz.entdiy.somersault.module.infra.service.config.ConfigService;
...
public class ConfigController {
    ...
    @Parameter(name = "key", description = "参数键", required = true)    public CommonResult<String> getConfigKey(@RequestParam("key") String key) {
