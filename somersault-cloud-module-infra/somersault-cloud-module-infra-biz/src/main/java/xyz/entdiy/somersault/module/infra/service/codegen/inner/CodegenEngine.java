package xyz.entdiy.somersault.module.infra.service.codegen.inner;
...
import xyz.entdiy.somersault.framework.common.util.date.LocalDateTimeUtils;
...
import xyz.entdiy.somersault.module.infra.enums.codegen.CodegenFrontTypeEnum;
...
public class CodegenEngine {
    ...
    private static String javaModuleFilePath(String path, String module, String src) {
        return "somersault-cloud-module-${table.moduleName}/" + // 顶级模块
                "somersault-cloud-module-${table.moduleName}-" + module + "/" + // 子模块
                "src/" + src + "/java/${basePackage}/module/${table.moduleName}/" + path + ".java";
    }

    private static String mapperXmlFilePath() {
        return "somersault-cloud-module-${table.moduleName}/" + // 顶级模块
                "somersault-cloud-module-${table.moduleName}-biz/" + // 子模块
    ...
    private static String vueFilePath(String path) {
        return "somersault-cloud-ui-${sceneEnum.basePackage}/" + // 顶级目录
                "src/" + path;
    }
    ...
    private static String vue3FilePath(String path) {
        return "somersault-cloud-ui-${sceneEnum.basePackage}-vue3/" + // 顶级目录
                "src/" + path;
    }
