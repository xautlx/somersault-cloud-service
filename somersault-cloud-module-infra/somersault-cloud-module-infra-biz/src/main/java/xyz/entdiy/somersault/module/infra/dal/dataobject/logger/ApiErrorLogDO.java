package xyz.entdiy.somersault.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 xyz.entdiy.somersault.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
