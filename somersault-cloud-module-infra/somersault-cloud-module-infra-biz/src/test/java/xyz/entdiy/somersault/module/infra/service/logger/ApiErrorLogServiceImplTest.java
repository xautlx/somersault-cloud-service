...
import xyz.entdiy.somersault.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import xyz.entdiy.somersault.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static xyz.entdiy.somersault.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static xyz.entdiy.somersault.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("somersault-cloud-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("somersault-cloud-test");
