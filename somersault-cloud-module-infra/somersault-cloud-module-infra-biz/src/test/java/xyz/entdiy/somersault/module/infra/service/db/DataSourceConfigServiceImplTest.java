package xyz.entdiy.somersault.module.infra.service.db;

import cn.hutool.core.map.MapUtil;
import cn.hutool.core.util.ReflectUtil;
import cn.hutool.crypto.symmetric.AES;
import xyz.entdiy.somersault.framework.mybatis.core.type.EncryptTypeHandler;
import xyz.entdiy.somersault.framework.mybatis.core.util.JdbcUtils;
import xyz.entdiy.somersault.framework.test.core.ut.BaseDbUnitTest;
import xyz.entdiy.somersault.module.infra.controller.admin.db.vo.DataSourceConfigCreateReqVO;
import xyz.entdiy.somersault.module.infra.controller.admin.db.vo.DataSourceConfigUpdateReqVO;
import xyz.entdiy.somersault.module.infra.dal.dataobject.db.DataSourceConfigDO;
import xyz.entdiy.somersault.module.infra.dal.mysql.db.DataSourceConfigMapper;
...
import static xyz.entdiy.somersault.module.infra.enums.ErrorCodeConstants.DATA_SOURCE_CONFIG_NOT_EXISTS;
...
public class DataSourceConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void setUp() {
        ...
        when(dynamicDataSourceProperties.getDatasource()).thenReturn(MapUtil.of("primary",
                new DataSourceProperty().setUrl("http://localhost:3306").setUsername("ceshi").setPassword("tudou")));
    }
    ...
    public void testGetDataSourceConfig_master() {
        ...
        assertEquals("ceshi", dataSourceConfig.getUsername());
    ...
    public void testGetDataSourceConfigList() {
        ...
        assertEquals("ceshi", dataSourceConfigList.get(0).getUsername());
