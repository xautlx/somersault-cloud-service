...
import xyz.entdiy.somersault.framework.test.core.util.AssertUtils;
...
import xyz.entdiy.somersault.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static xyz.entdiy.somersault.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("测试")));
       // 测试 status 不匹配
