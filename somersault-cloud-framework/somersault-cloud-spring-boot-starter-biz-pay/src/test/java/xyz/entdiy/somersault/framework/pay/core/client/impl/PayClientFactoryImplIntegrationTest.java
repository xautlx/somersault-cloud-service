package xyz.entdiy.somersault.framework.pay.core.client.impl;

import cn.hutool.core.io.IoUtil;
import cn.hutool.core.util.RandomUtil;
import xyz.entdiy.somersault.framework.pay.core.client.PayClient;
import xyz.entdiy.somersault.framework.pay.core.client.dto.order.PayOrderUnifiedReqDTO;
import xyz.entdiy.somersault.framework.pay.core.client.impl.alipay.AlipayPayClientConfig;
import xyz.entdiy.somersault.framework.pay.core.client.impl.alipay.AlipayQrPayClient;
import xyz.entdiy.somersault.framework.pay.core.client.impl.alipay.AlipayWapPayClient;
import xyz.entdiy.somersault.framework.pay.core.client.impl.weixin.WxPayClientConfig;
import xyz.entdiy.somersault.framework.pay.core.client.impl.weixin.WxPubPayClient;
import xyz.entdiy.somersault.framework.pay.core.enums.channel.PayChannelEnum;
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_WX_PUB_V3() throws FileNotFoundException {
        ...
        config.setPrivateKeyContent(IoUtil.readUtf8(new FileInputStream("/Users/test/Downloads/wx_pay/apiclient_key.pem")));
        config.setPrivateCertContent(IoUtil.readUtf8(new FileInputStream("/Users/test/Downloads/wx_pay/apiclient_cert.pem")));
...
//        System.out.println(result);
    ...
    public void testCreatePayClient_ALIPAY_QR() {
        ...
        // 发起支付
        PayOrderUnifiedReqDTO reqDTO = buildPayOrderUnifiedReqDTO();
        reqDTO.setNotifyUrl("http://ceshi.natapp1.cc/admin-api/pay/notify/callback/18"); // TODO @tina: 这里改成你的 natapp 回调地址
