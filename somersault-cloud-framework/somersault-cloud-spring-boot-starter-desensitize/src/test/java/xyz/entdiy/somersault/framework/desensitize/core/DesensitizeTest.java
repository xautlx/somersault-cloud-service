package xyz.entdiy.somersault.framework.desensitize.core;
...
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.BankCardDesensitize;
...
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.FixedPhoneDesensitize;
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.IdCardDesensitize;
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.PasswordDesensitize;
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.MobileDesensitize;
import xyz.entdiy.somersault.framework.desensitize.core.slider.annotation.SliderDesensitize;
...
public class DesensitizeTest extends BaseMockitoUnitTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("测试");
        ...
        desensitizeDemo.setRegex("你好，我是测试");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("测试");

        // 调用
        DesensitizeDemo d = JsonUtils.parseObject(JsonUtils.toJsonString(desensitizeDemo), DesensitizeDemo.class);
        // 断言
        assertNotNull(d);
        assertEquals("测*", d.getNickname());
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "测试", replacer = "*")
