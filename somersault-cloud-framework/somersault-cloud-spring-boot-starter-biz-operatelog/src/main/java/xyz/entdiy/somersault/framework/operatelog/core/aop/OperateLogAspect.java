package xyz.entdiy.somersault.framework.operatelog.core.aop;
...
import xyz.entdiy.somersault.framework.common.util.monitor.TracerUtils;
import xyz.entdiy.somersault.framework.common.util.servlet.ServletUtils;
import xyz.entdiy.somersault.framework.operatelog.core.enums.OperateTypeEnum;
import xyz.entdiy.somersault.framework.operatelog.core.service.OperateLog;
...
import static xyz.entdiy.somersault.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static xyz.entdiy.somersault.framework.common.exception.enums.GlobalErrorCodeConstants.SUCCESS;
...
public class OperateLogAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, Operation operation) throws Throwable {
        ...
        xyz.entdiy.somersault.framework.operatelog.core.annotations.OperateLog operateLog = getMethodAnnotation(joinPoint,
                xyz.entdiy.somersault.framework.operatelog.core.annotations.OperateLog.class);
    ...
    public Object around(ProceedingJoinPoint joinPoint,
                         xyz.entdiy.somersault.framework.operatelog.core.annotations.OperateLog operateLog) throws Throwable {
        return around0(joinPoint, operateLog, null);
    }

    private Object around0(ProceedingJoinPoint joinPoint,
                           xyz.entdiy.somersault.framework.operatelog.core.annotations.OperateLog operateLog,
