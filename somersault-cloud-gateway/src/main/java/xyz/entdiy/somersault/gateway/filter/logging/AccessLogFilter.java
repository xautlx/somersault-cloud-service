package xyz.entdiy.somersault.gateway.filter.logging;

import cn.hutool.core.date.LocalDateTimeUtil;
import cn.hutool.core.map.MapUtil;
import cn.hutool.json.JSONUtil;
import xyz.entdiy.somersault.framework.common.util.json.JsonUtils;
import xyz.entdiy.somersault.gateway.util.SecurityFrameworkUtils;
import xyz.entdiy.somersault.gateway.util.WebFrameworkUtils;
 ...
 * 网关的访问日志过滤器
 *
 * 从功能上，它类似 somersault-cloud-spring-boot-starter-web 的 ApiAccessLogFilter 过滤器
 *
